        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 lg:gap-12 max-w-5xl mx-auto">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-white rounded-2xl p-6 shadow-soft h-full flex flex-col items-center text-center relative z-10">
                ...
                <h3 className="text-xl font-semibold text-slayd-text mb-3">
                  Step {index + 1}: {step.title}
                </h3>
                <p className="text-slayd-text/70">
                  {step.description}
                </p>
              </div>
